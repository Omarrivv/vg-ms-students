...
public class ClassroomStudentRest {
    ...
    public Flux<ClassroomStudentResponse> findByEnrollmentYear(@PathVariable String enrollmentYear) {
        return classroomStudentService.findByEnrollmentYear(enrollmentYear);
    }

    @GetMapping("/period/{enrollmentPeriod}")
    public Flux<ClassroomStudentResponse> findByEnrollmentPeriod(@PathVariable String enrollmentPeriod) {
